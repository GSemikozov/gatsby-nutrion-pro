...
import deerIcon from './images/deer-icon.png';
import heroMobImg from './images/ny-ads-hero.jpg';
    ...
    <>
      ...
      <MobileView>
        <section className={styles.heroMobile}>
          ...
          <div className={styles.offersList}>
            <div className={styles.offersListMobileItemWrapper}>
              <div className={cx(styles.offersListItem, styles.red)}>
                ...
                <div className={styles.offersListItemBody}>
                  <span>Sleva</span>
                  <span className={styles.offersListMobileItemPrice}>20%</span>
                </div>
              </div>
              <div className={styles.offersListMobileItemInfo}>
                na měsiční program
            ...
            <div className={styles.offersListMobileItemWrapper}>
              <div className={cx(styles.offersListItem, styles.green)}>
                ...
                <div className={styles.offersListItemBody}>
                  <span>Sleva</span>
                  <span className={styles.offersListMobileItemPrice}>10%</span>
                </div>
              </div>
              <div className={styles.offersListMobileItemInfo}>
                na dvoutydenní program
          ...
          <img src={heroMobImg} className={styles.heroMobileImg} alt="img" />
          <div className="text-center">
            <Button
              type="primary"
              className={cx({ ["hide"]: !openBtn }, styles.btnShowMore)}
          ...
          <div className={cx(styles.desc, { [styles.descHidden]: !showForm })}>
            <div className={styles.heroForm}>
              <HeroNYForm />
            </div>
            <div
